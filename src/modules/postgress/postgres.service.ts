...
export class PostgresService implements TypeOrmOptionsFactory {
  constructor(private readonly configService: ConfigService<Config>) {} // достукаємось до наших .env
  createTypeOrmOptions(): TypeOrmModuleOptions {
    const postgresConfig = this.configService.get<PostgresConfig>('postgres'); // витягаємо наші конфіги для постгесу
    return {
      type: 'postgres',
