...
export class AuthCacheService {
  ...
  public async saveToken(
    ...
    await this.redisService.addOneToSet(key, accessToken); // зберігаємо з ключом
    await this.redisService.expire(key, this.jwtConfig.accessTokenExpiration); // до ключа говоримо видалятись за певний час
  }
